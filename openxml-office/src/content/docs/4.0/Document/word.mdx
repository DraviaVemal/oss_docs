...
<table><thead><tr><th width="240">Rust</th><th width="220">C#</th><th>Function</th></tr></thead><tbody>
<tr><td><code>Word::new(path, props)</code></td><td><code>new Word(props)</code> / <code>new Word(path, props)</code></td><td>Create a new document or open an existing file</td></tr>
<tr><td><code>save_as(path)</code></td><td><code>SaveAs(path)</code></td><td>Save the document to a file</td></tr>
</tbody></table>
...
<tr><td><code>IsInMemory</code></td><td>bool</td><td>Keep the document buffered in memory instead of on disk</td></tr>
</tbody></table>
