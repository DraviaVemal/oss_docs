...
<table>
    ...
    <tbody>
        <tr>
            <td><code>PowerPoint::new(path, props)</code></td>
            <td><code>new PowerPoint(props)</code> / <code>new PowerPoint(path, props)</code></td>
            <td>Create a new presentation or open an existing file</td>
        </tr>
        <tr>
            <td><code>save_as(path)</code></td>
            <td><code>SaveAs(path)</code></td>
            <td>Save the presentation to a file</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>bool</td>
            <td>Keep the presentation buffered in memory instead of on disk</td>
        </tr>
    </tbody>
</table>
